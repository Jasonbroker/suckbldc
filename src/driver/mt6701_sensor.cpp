...
//       // .flags = SPICOMMON_BUSFLAG_DUAL 使用双spi
//   };
// #ifdef ESP32S3
//   esp_err_t ret = spi_bus_initialize(SPI3_HOST, &tx_bus_config, SPI_DMA_DISABLED);
// #else
//   esp_err_t ret = spi_bus_initialize(HSPI_HOST, &tx_bus_config, SPI_DMA_CH1);
// #endif
//   ESP_ERROR_CHECK(ret);
